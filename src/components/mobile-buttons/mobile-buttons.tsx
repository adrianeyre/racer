	...
	public render() {
		return <div className="mobile-buttons">
			<div className="button-row">
				<button type="button" onClick={ this.props.handleMobileButton.bind(this, PlayerResultEnum.ARROW_UP) }>FASTER</button>
			</div>
			<div className="button-row">
			...
			<div className="button-row">
				<button type="button" onClick={ this.props.handleMobileButton.bind(this, PlayerResultEnum.ARROW_DOWN) }>SLOWER</button>
			</div>
		</div>
	}
}
